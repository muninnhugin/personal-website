...
Bootstrap documentation: https://getbootstrap.com/docs/5.3/getting-started/
Embedding PDF: https://www.codexworld.com/embed-pdf-document-file-in-html-web-page/
Palleton theme: http://paletton.com/#uid=13i0u0kllllaFw0g0qFqFg0w0aF
Mozilla HTML documentation: https://developer.mozilla.org/en-US/docs/Web/HTML/Element

5. What classmates or other individuals did you consult as part of this assignment? What did you discuss?
Questions and answers on Slack


6. Is there anything special we need to know in order to run your code?
bootstrap.min.css needs to be downloaded
